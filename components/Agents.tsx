...
const Agents = ({userName, userId, type} : AgentProps) => {
    ...
    useEffect(() => {
     ...
     useEffect(() => {
        if(callStatus === CallStatus.COMPLETED) router.push('/');
    ...
    const isCallInactiveOrCompleted = callStatus === CallStatus.INACTIVE || callStatus === CallStatus.COMPLETED;
    ...
    <div className='call-view'>
        <div className='card-interviewer'>
            <div className='avatar'>
                <Image src='/ai-avatar.png' alt='vapi' width={68} height={54} className='object-cover' />
    ...
    <div className='flex w-full justify-center'>
        {callStatus !== 'ACTIVE' ? (
            <button className='relative btn-call' onClick={handleCall}>
                ...
                <span>
                    {isCallInactiveOrCompleted ? 'Call' : '...'}
